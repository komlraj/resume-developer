      ...
      <div className='temp1 wrapper'> 
       ...
       <div className='row'>
          <div className='col-1-2'>
            <h5 className='summary-title color2'>Summary</h5>
            ...
            <div>
            <h5 className='skill-title color2'>Skills & Abilities</h5>
            ...
            <div>
              <h5 className='language-title color2'>Languages</h5>
              <div>
                <div>90%</div>
                <span>Hindi</span>
              </div>
            ...
            <div>
              <h5 className='interest-title color2'>Interests</h5>
          ...
          <div className='col-1-2'>
            ...
            <p className='color2'>University of Washington, Seattle, WA</p>
            <p>Bachelor of Arts in Communication Studies</p>
            <p className='color2'>Professional Experience</p>
            <div>
              <span className='color2'>Comapny 1 Seattle, WA</span>
              <span className='color2'>2008-present</span>
              <span className='color2'>position: Product Manager </span>
            ...
            <div>
              ...
              <p className='color2'><span>position:</span> Developmental Edior </p>
              <p>Recursion is a programming pattern that is useful in situations when a task can be naturally split into several tasks of the same kind, but simpler. Or when a task can be simplified into an easy action plus a simpler variant of the same task.</p>
            </div>
          </div>
       </div>
